$(function(){
    ...
    function addOneMessage(message){
        ...
        let messageText = $('<div class="message-text"><p class="text">' + message.message + '</p></div>');
                                                                                                                                                                                                                                                               consoleLog("время - " + new Date(message.dateTime)); //Fri Apr 08 2022 18:01:02 GMT+0300 (Москва, стандартное время)
                                                                                                                                                                                                                                                               consoleLog( new Date( (60000 * (new Date(message.dateTime).getTimezoneOffset() - new Date().getTimezoneOffset()) ) ) ); //Thu Jan 01 1970 03:00:00 GMT+0300 (Москва, стандартное время)
                                                                                                                                                                                                                                                               consoleLog(new Date(new Date(message.dateTime).getTime() - ( 60000 * (new Date(message.dateTime).getTimezoneOffset() - (new Date().getTimezoneOffset()) ) ) )); //Fri Apr 08 2022 18:01:02 GMT+0300 (Москва, стандартное время)
                                                                                                                                                                                                                                                               consoleLog(new Date(new Date(message.dateTime).getTime() - ( 60000 * (new Date(message.dateTime).getTimezoneOffset() + (new Date().getTimezoneOffset()) ) ) )); //Sat Apr 09 2022 00:01:02 GMT+0300 (Москва, стандартное время)
                                                                                                                                                                                                                                                               consoleLog(new Date(new Date(message.dateTime).getTime() + ( 60000 * (new Date(message.dateTime).getTimezoneOffset() - (new Date().getTimezoneOffset()) ) ) )); //Fri Apr 08 2022 18:01:02 GMT+0300 (Москва, стандартное время)
                                                                                                                                                                                                                                                               consoleLog(new Date(new Date(message.dateTime).getTime() + ( 60000 * (new Date(message.dateTime).getTimezoneOffset() + (new Date().getTimezoneOffset()) ) ) )); //Fri Apr 08 2022 12:01:02 GMT+0300 (Москва, стандартное время)
                                                                                                                                                                                                                                                               consoleLog(new Date(message.dateTime).getTimezoneOffset());
                                                                                                                                                                                                                                                               consoleLog(new Date().getTimezoneOffset());
                                                                                                                                                                                                                                                               consoleLog(new Date(new Date.getTime()).dateTime());
